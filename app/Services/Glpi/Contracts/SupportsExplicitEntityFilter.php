 ...
 * soit le scope actif (cf. Domain, issue #14 ; Location, issue #13). GlpiSyncService
 * retente alors un filtrage explicite côté connecteur, par comparaison de chemin (completename)
