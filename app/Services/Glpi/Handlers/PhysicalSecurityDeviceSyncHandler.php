...
class PhysicalSecurityDeviceSyncHandler implements SyncHandler, SupportsBayResolution
{
    ...
    public function __construct(private readonly PhysicalSecurityDeviceMapper $mapper) {}
    ...
    {
        return 'physical-security-devices';
    }
     ...
     * dans GLPI_NETWORK_DEVICE_TYPES_PHYSICAL_SECURITY_DEVICES. Vide = aucun (opt-in explicite).
     */
    public function filterItem(array $item): bool
    {
        $allowed = config('glpi.network_device_types.physical_security_devices', []);
