...
class StorageDeviceSyncHandler implements SyncHandler, SupportsBayResolution
{
    use MatchesGlpiDropdownType;

    public function __construct(private readonly StorageDeviceMapper $mapper) {}
     ...
     * dans GLPI_NETWORK_DEVICE_TYPES_STORAGE_DEVICES. Vide = aucun (opt-in explicite).
     */
    public function filterItem(array $item): bool
    {
        $allowed = config('glpi.network_device_types.storage_devices', []);
