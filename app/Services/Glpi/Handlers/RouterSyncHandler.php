...
class RouterSyncHandler implements SyncHandler, SupportsBayResolution
{
    use MatchesGlpiDropdownType;

    public function __construct(private readonly RouterMapper $mapper) {}
     ...
     * dans GLPI_NETWORK_DEVICE_TYPES_ROUTERS. Vide = aucun (opt-in explicite).
     */
    public function filterItem(array $item): bool
    {
        $allowed = config('glpi.network_device_types.routers', []);
